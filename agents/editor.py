...
- expand — расширь текст на 30-40%, добавь конкретики, деталей, примеров
- punch — сделай текст хлёстче, резче, мощнее — каждое слово должно бить
- grammar — исправь все грамматические, пунктуационные и стилистические ошибки, не меняй смысл
